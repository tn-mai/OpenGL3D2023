...
`distance`(ディスタンス)は「球の中心から最も近い平面までの距離」です。`for`ループによって6つの平面までの距離を調べ、距離が最も短い平面が「押し返す方向」として選ばれます。
...
「OBBと球体の交差判定」が「AABBと球体の交差判定」と似ていたように、「OBBと光線の交差判定」も「AABBと光線の交差判定」とよく似ています。どちらも光線とスラブの交差判定を繰り返すことで判定を実行します。
