...
<pre class="tnmai_assignment">
<strong>【課題02】</strong>
以下のURLから<code>ghost.obj</code>(ゴースト・オブジェ), <code>ghost.mtl</code>, <code>ghost.png</code>, <code>というOBJファイルをダウンロードして、
プロジェクトの<code>Res/MeshData/ghost</code>フォルダに保存しなさい(<code>ghost</code>フォルダは作成すること)。
