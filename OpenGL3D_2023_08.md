...
`AddVertexData`関数の定義の下に、次のプログラムを追加してください。
...
### 1.9 EngineクラスにPrimitiveBufferを追加する
...
### 1.11 古いVBO, IBO, VAOを使ったプログラムを削除する
...
それではOBJファイルを読み込んでみましょう。

<pre class="tnmai_assignment">
<strong>【課題05】</strong>
以下のURLから<code>skull_highpoly.obj</code>というOBJファイルをダウンロードして、プロジェクトの<code>Res/MeshData</code>フォルダに保存しなさい。
